...
<div className="flex justify-center items-center">
      {incorrectGuessCount === 1 && (
        <p className="animate-fade-in-out animate-fade-out text-9xl text-red-700 font-bold">X</p>
      )}
      {incorrectGuessCount === 2 && (
        <p className="animate-fade-in-out text-9xl text-red-700 font-bold">X X</p>
      )}
      {incorrectGuessCount >= 3 && (
        <div className="flex flex-col items-center">
        <p className="animate-fade-in-out text-9xl text-red-700 font-bold">X X X</p>
