        ...
        <div className="px-5 w-full border-4 pb-4 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {/* HEADING */}
                <div className="flex place-content-center py-3">  
                    ...
                    <h5 className="text-xl font-semibold text-gray-900 md:text-3xl
                        mx-4">In Progress
                    </h5>
            ...
            {user.inProgress.word.map((wordsMastered) => (
...
// In Queue
// </h5>
// <p className="text-sm font-normal text-gray-500 dark:text-gray-400">Information</p>
...
// <span className="flex-1 ms-3 whitespace-nowrap">THREES</span>
...
// <span className="flex-1 ms-3 whitespace-nowrap">THREES TO FOURS</span>
// </a>
// </li>
// <li>
// <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
...
// <span className="flex-1 ms-3 whitespace-nowrap">FOURS</span>
// </a>
// </li>
// <li>
// <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
...
// <span className="flex-1 ms-3 whitespace-nowrap">Pattern Stems</span>
// </a>
// </li>
// <li>
// <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
...
// <span className="flex-1 ms-3 whitespace-nowrap">Probability Stems</span>
// </a>
// </li>
// </ul>
// <div>
